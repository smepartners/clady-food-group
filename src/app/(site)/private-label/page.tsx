...
import { Section, ImageFrame, IconFeature, Pill, CTAButton } from "@/components/ui";

export const metadata: Metadata = { title: "Private Label" };

const PILLARS = [
  { icon: Package, name: "Product expertise", body: "Knowledge across a broad range of beverage categories and formats." },
  { icon: ChartLineUp, name: "Market awareness", body: "An understanding of changing consumer tastes and emerging beverage trends." },
  { icon: Lightning, name: "Flexibility", body: "Solutions developed around different customer requirements, channels and price points." },
  { icon: CheckCircle, name: "Consistency", body: "A focus on dependable product quality and reliable customer relationships." },
  { icon: UsersThree, name: "Collaboration", body: "A partnership approach from initial brief through to finished product." },
];
