...
import { Section, Pending, ImageFrame, IconFeature, CTAButton } from "@/components/ui";

const VALUES = [
  { icon: Sparkle, name: "Excellence", body: "High standards in everything we do, whether that's branded or white labelled." },
  { icon: Lightbulb, name: "Innovation", body: "Looking ahead to what's next, keeping our customers ahead of the trends." },
  { icon: CheckCircle, name: "Consistency", body: "Reliable quality, flavours and product profiles, every time." },
  { icon: Lightning, name: "Agility", body: "The world and consumers move fast; that's why we respond quickly to changing needs." },
  {
    icon: UsersThree,
    name: "Collaboration",
...
export default function HomePage() {
  return (
    <>
      ...
      <Section>
        <div className="rounded-2xl bg-green-700 px-8 py-14 text-center sm:px-16">
          ...
          <div className="mt-8 flex justify-center">
            <Link
              href="/contact"
              className="inline-flex items-center justify-center rounded-full bg-cream-100 px-6 py-3 text-sm font-medium text-green-700 transition hover:bg-cream-200 active:scale-[0.98]"
            >
